...
namespace MoviePro.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public MoviesController(IDataMappingService tmdbMappingService, IOptions<AppSettings> appSettings, ApplicationDbContext context, IImageService imageService, IRemoteMovieServices tmdbMovieService)
        {
